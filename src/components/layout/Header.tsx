      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <NavItem label="COMPANIONS" isActive={currentPage === 'companions'} onClick={() => handleNavClick('companions')} />
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden absolute top-full left-0 w-full bg-slate-900/95 backdrop-blur-md">
          <div className="container mx-auto px-4 py-4 flex flex-col space-y-4">
            ...
            <MobileNavItem label="COMPANIONS" isActive={currentPage === 'companions'} onClick={() => handleNavClick('companions')} />
